...
public class Background {
    ...
    static public URL screenquad_vertex =
            Background.class.getResource("/assets/shaders/screenquad_vertex.glsl");
    static public URL screenquad_fragment =
    ...
    public void createOnGlThread(Context context) {
        ...
        int vertexShader =
                Utils.loadGLShader("Shader", context, GLES20.GL_VERTEX_SHADER, screenquad_vertex);
        int fragmentShader =
                Utils.loadGLShader(
                        "Shader", context, GLES20.GL_FRAGMENT_SHADER, screenquad_fragment);
        ...
        Utils.checkGLError("Shader", "Program creation");

        quadPositionParam = GLES20.glGetAttribLocation(quadProgram, "a_Position");
        quadTexCoordParam = GLES20.glGetAttribLocation(quadProgram, "a_TexCoord");

        Utils.checkGLError("Shader", "Program parameters");
    }
    ...
    public void draw(Frame frame) {
        ...
        Utils.checkGLError("Shader", "Draw");
    }
